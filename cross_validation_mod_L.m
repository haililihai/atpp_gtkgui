function [mdice,mnmi,mcv]=cross_validation_mod_L(wd,prefix,part,sub_list,kc,iter,prob_thre,mpm_thre)
...
fp=fopen(strcat(wd,'/validation/',part,'_L_stability_index.txt'),'at');
if fp
